...
@section("content")
    ...
    <div class="breadcrumbs-area">
        ...
        <ul>
            ...
            <li>Add New Provisor</li>
        </ul>
    </div>

    <!-- Add New Provisor Area Start Here -->
    <div class="card height-auto">
        <div class="card-body">
            <div class="heading-layout1">
                <div class="item-title">
                    <h3>Add New Provisor</h3>
                </div>
            </div>
            <form class="new-added-form" method="POST" action="{{route('provisor.create')}}">
                @csrf
                <div class="row">
    ...
    <!-- Add New Provisor Area End Here -->
